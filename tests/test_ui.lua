...
t.describe("ui.progress_bar", function()
  t.it("renders correct fill proportions", function()
    t.assert_eq(ui.progress_bar(0.00, 10), string.rep(".", 10))
    t.assert_eq(ui.progress_bar(0.50, 10), string.rep("#", 5) .. string.rep(".", 5))
    t.assert_eq(ui.progress_bar(1.00, 10), string.rep("#", 10))
  end)
end)
...
t.describe("ui.format_fuel", function()
  t.it("abbreviates thousands with k suffix", function()
    ...
    t.assert_eq(ui.format_fuel("unlimited"), "inf")
  end)
end)
